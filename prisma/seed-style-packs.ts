...
// Helper to generate consistent placeholder URLs
// Using picsum.photos with seed for consistent images per style
const placeholder = (category: string, variant: string, size = 400) =>
  `https://picsum.photos/seed/${category}-${variant}/${size}/${size}`;
...
const STYLE_PACKS = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "classic",
    sortOrder: 1,
    thumbnailUrl: placeholder("royal-gallery", "thumb", 300),
    isActive: true,
    isPremium: false,
    variants: [
      {
        ...
        sortOrder: 1,
        sampleImageUrl: placeholder("royal-gallery", "renaissance"),
      ...
      },
      {
        ...
        sortOrder: 2,
        sampleImageUrl: placeholder("royal-gallery", "baroque"),
      ...
      },
      {
        ...
        sortOrder: 3,
        sampleImageUrl: placeholder("royal-gallery", "rococo"),
      ...
      },
      {
        ...
        sortOrder: 4,
        sampleImageUrl: placeholder("royal-gallery", "tudor"),
      ...
      },
      {
        ...
        sortOrder: 5,
        sampleImageUrl: placeholder("royal-gallery", "imperial"),
      ...
      },
      {
        ...
        sortOrder: 6,
        sampleImageUrl: placeholder("royal-gallery", "victorian"),
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    sortOrder: 2,
    thumbnailUrl: placeholder("masterpiece", "thumb", 300),
    isActive: true,
    isPremium: true,
    variants: [
      {
        ...
        sortOrder: 1,
        sampleImageUrl: placeholder("masterpiece", "starry-night"),
      ...
      },
      {
        ...
        sortOrder: 2,
        sampleImageUrl: placeholder("masterpiece", "mona-lisa"),
      ...
      },
      {
        ...
        sortOrder: 3,
        sampleImageUrl: placeholder("masterpiece", "great-wave"),
      ...
      },
      {
        ...
        sortOrder: 4,
        sampleImageUrl: placeholder("masterpiece", "pearl-earring"),
      ...
      },
      {
        ...
        sortOrder: 5,
        sampleImageUrl: placeholder("masterpiece", "water-lilies"),
      ...
      },
      {
        ...
        sortOrder: 6,
        sampleImageUrl: placeholder("masterpiece", "persistence"),
      ...
      },
      {
        ...
        sortOrder: 7,
        sampleImageUrl: placeholder("masterpiece", "the-kiss"),
      ...
      },
      {
        ...
        sortOrder: 8,
        sampleImageUrl: placeholder("masterpiece", "american-gothic"),
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "custom",
    sortOrder: 7,
    thumbnailUrl: placeholder("custom-scene", "thumb", 300),
    isActive: true,
    isPremium: true,
    variants: [
      {
        ...
        sortOrder: 1,
        sampleImageUrl: placeholder("custom-scene", "custom"),
